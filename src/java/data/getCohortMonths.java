...
if(cohorttype.equalsIgnoreCase("pmtct")){
data+="<option value='24m'>24m. Cohort ("+lc.getpreviousmonth(new Integer(year),new Integer(monthstring), -24)+") </option>";
...
data+="<option value='24m'>24m. Cohort ("+lc.getpreviousmonth(new Integer(year),new Integer(monthstring), -24)+") </option>"+
"<option value='36m'>36m. Cohort("+lc.getpreviousmonth(new Integer(year),new Integer(monthstring), -36)+")</option>";
//"<option value='48m'>48m. Cohort("+lc.getpreviousmonth(new Integer(year),new Integer(monthstring), -48)+")</option>"+
//+"<option value='60m'>60m. Cohort("+lc.getpreviousmonth(new Integer(year),new Integer(monthstring), -60)+")</option>";
}
            out.println(data);
