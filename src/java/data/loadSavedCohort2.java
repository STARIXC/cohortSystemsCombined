 ...
 * @author EKaunda
 */
public class loadSavedCohort2 extends HttpServlet {
...
//code to be executed if all the conditions are false  
            ...
            if (!mn.equals("") && !yr.equals("") && !fc.equals("")) {
                ...
                if (ct.equalsIgnoreCase("art")) {
                    ...
                    sql = "select id, indicator,IFNULL(child_"+cm+",'0') as child_"+cm+" , IFNULL(adult_" + cm + ",'0') as adult_" + cm + " , IFNULL(ayp_" + cm + ",'0') as ayp_" + cm + ", IFNULL(tl_" + cm + ",'0') as tl_" + cm + "  ";
